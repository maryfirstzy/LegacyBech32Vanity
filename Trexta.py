...
def generate_legacy_vanity_4_char(full_target_string):
    """
    Takes a full 4-character target string starting with '1'.
    Automatically splits it into a 3-character fixed base and 
    ...
    if len(full_target_string) != 4:
        raise ValueError("The target string must be exactly 4 characters long.")
    ...
    print(f"Searching for 4-character Legacy vanity address matching: '{full_target_string}'")
...
generate_legacy_vanity_4_char("1Smx") 
